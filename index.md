...
## Project Overview
This project was developed as part of the **Master of Technology (M.Tech)** program in Electrical Engineering. The objective was to design and build a fully automated electric cooking system capable of preparing food autonomously upon receiving orders via a mobile application.
